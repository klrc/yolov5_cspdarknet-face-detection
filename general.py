...
def try_load_from_cache(im_files, label_files, augment, label_size=DATASET_NUM_DIMS):
    # Check cache
...
def save_cache_to_disk(im_files, label_files, path=Path("./labels.cache"), label_size=DATASET_NUM_DIMS):
